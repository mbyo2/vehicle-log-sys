    ...
    children: [
      ...
      { path: "reset-password", element: withSuspense(<ResetPassword />) },
      {
        ...
        children: [
          ...
          { path: "drivers/:id", element: <ProtectedRoute allowedRoles={['super_admin', 'company_admin', 'supervisor']}><DriverDetails /></ProtectedRoute> },
          ...
          { path: "new-trip", element: <ProtectedRoute allowedRoles={['driver', 'supervisor', 'company_admin', 'super_admin']}><NewTrip /></ProtectedRoute> },
          { path: "new-trip/:vehicleId", element: <ProtectedRoute allowedRoles={['driver', 'supervisor', 'company_admin', 'super_admin']}><NewTrip /></ProtectedRoute> },
